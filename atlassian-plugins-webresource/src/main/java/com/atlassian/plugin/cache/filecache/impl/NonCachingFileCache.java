...
/**
 * This class is a pass through implementation of the filecache.
 * @since 2.11.0
 */
public class NonCachingFileCache implements FileCache
{
    /**
     * Will always call the stream provider for the contents of the stream and write it to the output.
