...
/**
 * Representation of an XML resource tag in a module descriptor providing information to find the resource and
...
public class ResourceDescriptor
{
    ...
    /**
     * Constructor that uses the &lt;resource&gt; tag.
     */
    public ResourceDescriptor(Element element)
    {
        ...
        {
            content = element.getTextTrim(); // TODO: fix this crappy shit up
        }
