...
public class BatchResource implements DownloadableResource, Resource
{
    /**
    ...
    public BatchResource(String moduleCompleteKey, String type, Map<String, String> params, String staticUrlPrefix)
    {
        this.moduleCompleteKey = moduleCompleteKey;
        this.type = type;
        this.params = params;
        this.staticUrlPrefix = staticUrlPrefix;
        this.batchName = "all." + type; //todo
    ...
    public static BatchResource parse(String url)
    {
        ...
        return new BatchResource(moduleKey, type, params, url.substring(0, startIndex));
    }
